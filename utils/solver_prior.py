...
class Solver(gorilla.solver.BaseSolver):
    ...
    def step(self, syn_data, real_data, mode):
        ...
        data = {
            ...
            'prior': torch.cat([syn_data['prior'], real_data['prior']], dim=0), #new
...
def draw_box_to_image(data, result, data_name, img_id):
    ...
    out_dir = "/home/pc/fusonghao/Category-level_6D_pose_estimation/IST-Net-main/test/test_prior15_2/vis_img40"
