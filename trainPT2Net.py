...
from utils.solver_PT2 import Solver, get_logger
from provider.dataset_prior import TrainingDataset
...
def init():
    ...
    log_dir = os.path.join("log", exp_name,'Without')
...
if __name__ == "__main__":
    ...
    if cfg.model_arch == "PT2Net":
        from model.PT2Net29without import PT2Net, SupervisedLoss
        model = PT2Net(cfg.num_category)
